...
export namespace messageCopy {
  ...
  export const yourWatchHasBeenSnoozed = `Your watch has been snoozed for 6 hours`;
  ...
  export const yourWatchHasBeenExtended = `Your watch has been extended for another 7 days`
