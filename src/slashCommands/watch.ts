import { APIActionRowComponent, APIMessageActionRowComponent, SlashCommandBuilder } from "discord.js"
import { SlashCommand } from "../types";
import { Server, WatchType } from "@prisma/client";
import { itemNameOptions, serverOptions, watchTypeOptions, priceCriteriaOptions } from "../lib/content/commandOptions/commandOptions";
...
import { ButtonInteractionTypes, buttonBuilder } from "../lib/content/buttons/buttonBuilder";
import { CommandTypes, buttonRowBuilder } from "../lib/content/buttons/buttonRowBuilder";
...
const command: SlashCommand = {
    ...
    .addNumberOption(priceCriteriaOptions) as unknown as SlashCommandBuilder,  // chaining commands confuses typescript =(
    execute: async interaction => {
        // TODO: when a user upserts a watch, it should not be snoozed
        const args: Args = getInteractionArgs(interaction, ['server', 'item', 'type'])
